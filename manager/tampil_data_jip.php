                    ...
                    ?>
                        <tr align="center">
                            ...
                            <td>
                                ...
                                if ($row['status'] == 0) {
                                ?>
                                    <a href="?menu=jip&action=konfirmasi&id=<?= $row['id_purchase_order'] ?>" class="btn btn-sm btn-success" onclick="return confirm('Apakah PO <?= $row['nama_perusahaan']; ?> Sudah Selesai?');">
                                        konfirmasi
                                    </a>
                                <?php
                                } else {

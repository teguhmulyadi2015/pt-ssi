    ...
    if (mysqli_num_rows($cek)) {
        ...
        if (strlen($password_baru) >= 5) {
            ...
            if ($password_baru == $konfirmasi_password) {
                ...
                echo '<script>alert("konfirmasi password tidak cocok"); document.location="../manager/index.php?menu=ganti_password&action=tampil";</script>';
            }
        } else {
            //kondisi jika password baru yang dimasukkan kurang dari 5 karakter
            echo '<script>alert("minimal password 5 karakter, silahkan coba kembali"); document.location="../manager/index.php?menu=ganti_password&action=tampil";</script>';
        }
    } else {
        //kondisi jika password lama tidak cocok dengan data yang ada di database
        echo '<script>alert("password lama tidak cocok, silahkan coba kembali"); document.location="../manager/index.php?menu=ganti_password&action=tampil";</script>';
    }
}

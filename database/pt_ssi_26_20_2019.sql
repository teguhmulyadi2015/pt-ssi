...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2019 at 05:52 AM
...
INSERT INTO `tbl_bahan_baku` (`id_bahan_baku`, `id_jenis_bahan_baku`, `nama_bahan_baku`, `stok`, `tgk_masuk`) VALUES
(2, 1, 'Pelat 20x120', 12, '2019-10-08'),
(3, 2, 'stiker vynil merah', 23, '2019-10-14');
...
INSERT INTO `tbl_hak_akses` (`id`, `hak_akses`) VALUES
(1, 'admin'),
(2, 'manager'),
(3, 'marketing'),
(4, 'qc');
...
(1, '123', 'pt pertaminia', 123, 'jalan 123a', 'jalan 123a', 'bapak pertaminia', '123', '123@123.coma', 'COD', 123, 'tidak ada', 123, 123, '2019-10-01', '2019-10-11', '2019-11-12', '2019-10-15', 3);
...
--
ALTER TABLE `tbl_bahan_baku_cacat`
  MODIFY `id_bahan_baku_cacat` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_purchaseorder`
  MODIFY `id_purchase_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
COMMIT;

...
--
-- Host: localhost:3306
-- Generation Time: Dec 21, 2019 at 09:26 AM
...
--
ALTER TABLE `tbl_bahan_baku_cacat`
  MODIFY `id_bahan_baku_cacat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_jenis_bahan_baku`
  MODIFY `id_jenis_bahan_baku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

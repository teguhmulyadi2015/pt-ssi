...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2020 at 04:10 AM
...
(31, 'PO10', 'BEBEK DOWER', 6, 'bandung', 'bandung', 'BEBEK DOWER', '081233', 'bebek@gmail.co.id', 'CASH', 3000, 'ada', 3000, 200, '2018-12-14', '2018-12-14', '2018-12-14', '2018-12-14', 0, 3),
...
--
ALTER TABLE `tbl_perencanaan`
  MODIFY `id_perencanaan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT for table `tbl_purchaseorder`
--
ALTER TABLE `tbl_purchaseorder`
  MODIFY `id_purchase_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
COMMIT;

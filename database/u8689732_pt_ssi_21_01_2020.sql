...
--
-- Host: localhost:3306
-- Generation Time: Jan 21, 2020 at 04:09 PM
...
(55, '1234', 'PT ABC', 100, 'Bandung', 'Bandung', 'Pak Emir', '08111111111', 'emir.daymen@safetysign.co.id', 'COD', 1000000, 'ada', 500000, 0, '2020-01-09', '2020-01-11', '2020-01-13', '2020-01-12', 0, 3);
...
--
ALTER TABLE `tbl_purchaseorder`
  MODIFY `id_purchase_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
COMMIT;

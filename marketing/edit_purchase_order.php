...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="proses_edit_data_purchase_order.php" method="POST" onSubmit="return validasi()">
            ...
            ?>
                <input type="hidden" name="id" value="<?= $row['id_purchase_order']; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="metode_pembayaran" class="form-control" id="metode_pembayaran">
                            ...
                            <option value="cash" <?php if ($row['metode_pembayaran'] == 'cash') {
                                                        echo 'selected';
                                                    } ?>>Cash</option>
                            <option value="cod" <?php if ($row['metode_pembayaran'] == 'cod') {
                                                    echo 'selected';
                                                } ?>>COD</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="ppn" class="form-control" id="ppn">
                            <option value="">--Pilih--</option>
                            <option value="ada" <?php if ($row['ppn'] == 'ada') {
                                                    echo 'selected';
                                                } ?>>Ada</option>
                            <option value="tidak ada" <?php if ($row['ppn'] == 'tidak ada') {
                                                            echo 'selected';
                                                        } ?>>Tidak Ada</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="po_masuk" name="po_masuk" value="<?= $row['start']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="jadwal_instalasi" class="col-sm-2 col-form-label">Deadline</label>
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="jadwal_instalasi" name="jadwal_instalasi" value="<?= $row['jadwal_instalasi']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="deadline" class="col-sm-2 col-form-label">Jadwal Instalasi</label>
                    <div class="col-sm-10">
...
<script type="text/javascript">
    function validasi() {
        ...
        if (nomor_po != "" && nama_perusahaan != "" && jumlah_pesanan != "" && alamat_pengiriman_barang != "" && alamat_pengiriman_invoice != "" && atas_nama != "" && no_telepon != "" && email != "" && metode_pembayaran != "" && harga_pesanan != "" && ppn != "" && dp != "" && biaya_instalasi != "" && po_masuk != "" && target_selesai != "" && jadwal_instalasi != "" && deadline != "") {
            return true;
        }
        if (nomor_po == "") {
            // Swal.fire(
        ...
        if (deadline == "") {
            ...
            //     'error'
            // );
            alert('tgl deadline harus diisi');
            return false;
        }
    }
</script>